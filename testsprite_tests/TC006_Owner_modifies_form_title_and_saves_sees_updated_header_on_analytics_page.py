...
async def run_test():
    ...
    try:
        ...
        # -> Click the LOGIN button (element index 627) to open the login page.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/header/div/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Input the email 'example@gmail.com' into the Email or phone field (element [44]) and click Next (element [82]).
        frame = context.pages[-1]
        # Input text
