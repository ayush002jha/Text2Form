...
async def run_test():
    ...
    try:
        ...
        # -> Fill email and password then click the Sign In button to attempt login (inputs: index 905 email, index 909 password, click index 910).
        ...
        # -> Click the 'Edit' action on the first visible form card (element index 11847).
        frame = context.pages[-1]
        # Click element
