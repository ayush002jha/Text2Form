...
async def run_test():
    ...
    try:
        ...
        # -> Type the test email into the email field (index 784).
        ...
        # -> Click the edit button for a form that may be not owned by the current user to trigger the access-denied flow (if such a form is present).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[3]/main/div/div[2]/div[2]/div[2]/div[3]/a[2]').nth(0)
        await asyncio.sleep(3); await elem.click()
