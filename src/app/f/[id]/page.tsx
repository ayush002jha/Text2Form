            ...
            {!form.user_id && (
              <div className="space-y-4 mb-8 border-y-4 border-dashed border-border/20 py-6">
                <p className="font-sans font-bold text-foreground text-lg">
                   <span className="font-pixel text-2xl uppercase tracking-widest text-primary mr-2">Guest Form:</span> 
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col sm:flex-row gap-6">
                    ...
                    <Button
                      ...
                      className="flex-1 h-20 inline-flex items-center justify-center gap-3 bg-card text-foreground border-4 border-border shadow-[4px_4px_0_var(--border)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0_var(--border)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none px-6 font-pixel text-xl uppercase tracking-wider transition-all"
                    >
                      <svg className="w-8 h-8 drop-shadow-[1px_1px_0px_rgba(0,0,0,0.1)]" viewBox="0 0 24 24">
