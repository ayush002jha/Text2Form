              ...
              {form.user_id ? (
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    ...
                    className="flex-1 h-14 inline-flex items-center justify-center gap-3 bg-primary text-primary-foreground border-4 border-border shadow-retro hover:shadow-retro-hover active:shadow-retro-active px-6 py-4 font-pixel text-lg uppercase tracking-wider transition-all"
                  >
                    Continue with Email
                  </Button>
                  <Button
                    ...
                    className="flex-1 h-14 inline-flex items-center justify-center gap-3 bg-card text-foreground border-4 border-border shadow-retro hover:shadow-retro-hover active:shadow-retro-active px-6 py-4 font-pixel text-lg uppercase tracking-wider transition-all"
                  >
