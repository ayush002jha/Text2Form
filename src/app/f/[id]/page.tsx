                ...
                <div className="flex flex-col gap-5">
                  <div className="flex flex-col lg:flex-row gap-3">
                    <Button
                      ...
                      className="flex-1 h-14 inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground border-4 border-border shadow-[4px_4px_0_var(--border)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0_var(--border)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none px-3 font-pixel text-base uppercase tracking-wider transition-all"
                    >
                      Continue with Email
                    </Button>
                    <Button
                      ...
                      className="flex-1 h-14 inline-flex items-center justify-center gap-2 bg-card text-foreground border-4 border-border shadow-[4px_4px_0_var(--border)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0_var(--border)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none px-3 font-pixel text-base uppercase tracking-wider transition-all"
                    >
                      <svg className="w-5 h-5 shrink-0 drop-shadow-[1px_1px_0px_rgba(0,0,0,0.1)]" viewBox="0 0 24 24">
